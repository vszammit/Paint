...
let thick: thickness = {t = 5}

(**A type for background color that is mutable**)
type background_color = {mutable c: int}
let bg: background_color = {c = 255}
...
type gctx = {
  ...
  background_color: background_color; (** the current background color *)
  }
